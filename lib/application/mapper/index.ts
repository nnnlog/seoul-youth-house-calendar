...
면책 사항<ul><li>이 정보는 Google의 Gemini를 이용하여 자동으로 처리되었습니다.</li><li>제공되는 정보는 정확하지 않을 수 있으며, 청약 신청 전 모집 공고를 직접 확인하시기를 권장합니다.</li></ul>

안내 사항<ul><li>이 캘린더는 <a href="https://github.com/nnnlog/seoul-youth-house-calendar">Github</a>에서 오픈소스로 개발하고 있습니다.</li><li>문의/요청 사항 등은 <a href="https://nlog.dev">nlog.dev</a>의 연락처를 참고해 보내주시면 감사하겠습니다.</li></ul>`,
        contentHash: sha256(post.content),
