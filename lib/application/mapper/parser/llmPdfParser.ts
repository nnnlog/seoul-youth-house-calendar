...
스키마 중 최상위 supply 설명
- 공급현황에 대해 자료를 정리합니다.
- 일반/특별 공급 각각에 대해서 청년/신혼부부형, 그리고 타입별로 공급 호수를 정리합니다.
- 일반 공급은 청년과 신혼부부 모두 지원 가능한 유형이 있을 수도 있습니다.

스키마 설명:
- special.youth: 특별공급 청년형
- special.marry: 특별공급 신혼부부형
- general.youth: 일반공급 청년형 (청년만 지원 가능)
- general.marry 일반공급 신혼부부형 (신혼부부만 지원 가능)
- general.all: 일반공급 신혼부부 혹은 청년형 (둘 다 지원 가능)
